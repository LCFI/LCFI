...
namespace llfi {
//fidl_1
class _IO_WrongSavedFormatInstSelector : public SoftwareFIInstSelector {
    public:
//fidl_2
    _IO_WrongSavedFormatInstSelector() {
        if (funcNames.size() == 0) {
//fidl_3
...
std::set<std::string> _IO_WrongSavedFormatInstSelector::funcNames;

static RegisterFIInstSelector A("WrongSavedFormat(IO)", new _IO_WrongSavedFormatInstSelector());
