...
//fidl_2
    _Timing_RaceConditionInstSelector() {
        if (funcNames.size() == 0) {
//fidl_3
            funcNames.insert(std::string("pthread_mutex_trylock"));
...
std::set<std::string> _Timing_RaceConditionInstSelector::funcNames;

static RegisterFIInstSelector A("RaceCondition(Timing)", new _Timing_RaceConditionInstSelector());
static RegisterFIRegSelector B("RaceCondition(Timing)", new FuncArgRegSelector(0));
