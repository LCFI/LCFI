...
//fidl_3
            ...
            funcNamesTargetArgs["fread"].insert(0);
        }
    }
...
//fidl_9
std::map<std::string, std::set<int> >  _IO_WrongSavedAddressInstSelector::funcNamesTargetArgs;
...
//fidl_10
        if (_IO_WrongSavedAddressInstSelector::isTarget(CI, reg)) {
            return true;
        } else { 
            return false;
        }
