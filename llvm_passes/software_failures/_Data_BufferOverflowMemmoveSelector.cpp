...
//fidl_4
        ...
        info["failure_mode"] = "BufferOverflowMemmove";
...
//fidl_6
        return key_partially_matches(func_name) != funcNames.end();
    }
...
std::set<std::string> _Data_BufferOverflowMemmoveInstSelector::funcNames;
