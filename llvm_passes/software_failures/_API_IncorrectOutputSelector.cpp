...
namespace llfi {
//fidl_1
class _API_IncorrectOutputInstSelector : public SoftwareFIInstSelector {
    public:
...
static RegisterFIInstSelector A("IncorrectOutput(API)", new _API_IncorrectOutputInstSelector());
