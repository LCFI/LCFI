...
namespace llfi {
//fidl_1
class _IO_WrongRetrievedFormatInstSelector : public SoftwareFIInstSelector {
    public:
//fidl_2
    _IO_WrongRetrievedFormatInstSelector() {
        if (funcNames.size() == 0) {
//fidl_3
...
std::set<std::string> _IO_WrongRetrievedFormatInstSelector::funcNames;

static RegisterFIInstSelector A("WrongRetrievedFormat(IO)", new _IO_WrongRetrievedFormatInstSelector());
